...
namespace BankLibrary
{
    public class BankAccount
    {
        ...
        internal BankAccount(decimal accountBalance, AccountType accountType)
        {
        ...
        /// <summary>
        /// Конструктор, используемый для заполнения полей экземпляра класса BankAccount,
        /// вызывающийся при отсутствии задаваемых параметров
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                if ((accountNumber == bankAccount.accountNumber) && (accountBalance == bankAccount.accountBalance) && (accountType == bankAccount.accountType))
                {
                    return true;
                }
            }
        ...
        {
            return $"На счёте {accountNumber} с типом {accountType} лежит {accountBalance}₽";
        }
    }
}